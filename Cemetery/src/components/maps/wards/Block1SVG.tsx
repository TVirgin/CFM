// src/components/maps/wards/Block1SVG.tsx
...
export const Block1SVG = React.forwardRef<SVGSVGElement, WardSVGProps>(
  (props, ref) => {
...
Block1SVG.displayName = "Block1SVG";

export default Block1SVG;